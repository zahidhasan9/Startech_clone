              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/apple-mac-pro"
                    >
                      Apple Mac Pro
                    </a>
                  </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/thunderobot-laptop"
                        >
                          Thunderobot
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/machenike-laptop"
                        >
                          Machenike
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/machenike-gaming-laptop"
                        >
                          Machenike
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/thunderobot-gaming-laptop"
                        >
                          Thunderobot
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/crelander-backpack"
                        >
                          Crelander
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/laptop-cooler"
                        >
                          Laptop Cooler
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/laptop-desk"
                        >
                          Laptop Desk
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/laptop-battery"
                        >
                          Laptop Battery
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/laptop-adapter"
                        >
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/laptop-locker"
                        >
                          Laptop Locker
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/arktek-intel-motherboard"
                        >
                          ARKTEK (Intel)
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/intel-graphics-card"
                        >
                          INTEL
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/gunnir-graphics-card"
                        >
                          GUNNIR
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/arktek-graphics-card"
                        >
                          ARKTEK
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/peladn-graphics-card"
                        >
                          PELADN
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/netac-desktop-ram"
                        >
                          Netac
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/corsair-laptop-ram"
                        >
                          Corsair
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/lian-li-power-supply"
                        >
                          Lian Li
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/revenger-power-supply"
                        >
                          Revenger
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/montech-power-supply"
                        >
                          Montech
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/evga-power-supply"
                        >
                          EVGA
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/zadak-ssd">
                            ZADAK
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/dahua-ssd">
                            Dahua
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/lexar-ssd">
                            Lexar
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/netac-ssd">
                            Netac
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/robot-ssd">
                            ROBOT
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/biwintech-ssd">
                            Biwintech
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/asus-portable-ssd"
                        >
                          Asus
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/pc-power-casing"
                        >
                          PC Power
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/silverstone-casing"
                        >
                          SilverStone
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/power-train-casing"
                        >
                          Power Train
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/revenger-casing-cooler"
                        >
                          Revenger
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/xigmatek-casing-cooler"
                        >
                          Xigmatek
                        </a>
                      </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/walton-monitor"
                    >
                      Walton
                    </a>
                  </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/kenson-ups-battery"
                        >
                          KENSON
                        </a>
                      </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/ips"
                    >
                      IPS
                    </a>
                  </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/oneplus-mobile-phone"
                    >
                      OnePlus
                    </a>
                  </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/infinix-mobile-phone"
                    >
                      Infinix
                    </a>
                  </li>
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/huawei-mobile-phone"
                    >
                      HUAWEI
                    </a>
                  </li>
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/nokia-mobile-phone"
                    >
                      Nokia
                    </a>
                  </li>
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/mobile-phone-charger-adapter"
                        >
                          Charger &amp; Adapter
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/mobile-phone-holder-stand"
                        >
                          Holder &amp; Stand
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/mobile-phone-case"
                        >
                          Case &amp; Cover
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/other-mobile-phone-accessories"
                        >
                          Others
                        </a>
                      </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/amazon-tablet-pc"
                    >
                      Amazon
                    </a>
                  </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/kidiby-tablet-pc"
                    >
                      Kidiby
                    </a>
                  </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/optoma-interactive-flat-panel"
                        >
                          Optoma
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/sprt-pos-printer"
                        >
                          SPRT
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/konica-minolta-photocopy-machine"
                        >
                          Konica Minolta
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/dinstar-ip-phone"
                        >
                          DINSTAR
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/dinstar-ip-pbx"
                        >
                          DINSTAR
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/xtreme-paper-shredder"
                        >
                          Xtreme
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/vimtag-portable-ip-camera"
                        >
                          Vimtag
                        </a>
                      </li>
              ...
              <li className="nav-item has-child c-2">
                ...
                <ul className="drop-down drop-menu-1">
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/comfast-router"
                        >
                          Comfast{" "}
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/pocket-router"
                    >
                      Pocket Router
                    </a>
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/zyxel-pocket-router"
                        >
                          Zyxel
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/tp-link-pocket-router"
                        >
                          TP-Link
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/cudy-pocket-router"
                        >
                          Cudy
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/huawei-pocket-router"
                        >
                          HUAWEI
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/cudy-range-extender"
                        >
                          Cudy
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/bdcom-switch"
                        >
                          BDCOM
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/dahua-network-switch"
                        >
                          Dahua
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/solitine-network-switch"
                        >
                          Solitine
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/networking/network-switch/hikvision-network-switch"
                        >
                          HikVision
                        </a>
                      </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/olt"
                    >
                      OLT
                    </a>
                  </li>
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/onu"
                    >
                      ONU
                    </a>
                  </li>
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/fiberfox-splicer-machine"
                        >
                          FiberFox
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/tumtec-splicer-machine"
                        >
                          TUMTEC
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/d-link-media-converter"
                        >
                          D-Link
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/tp-link-media-converter"
                        >
                          TP-Link
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/synology-nas-storage"
                        >
                          Synology
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/server-ssd"
                        >
                          SSD
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/server-networking/server-accessories/server-ram"
                        >
                          RAM
                        </a>
                      </li>
                ...
                <ul className="drop-down drop-menu-1">
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/kwg-keyboard">
                            KWG
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/rk-royal-kludge-keyboard">
                            ROYAL KLUDGE
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/deepcool-keyboard">
                            DeepCool
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/targus-keyboard">
                            Targus
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/benq-mouse">
                            Benq
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/matias-mouse">
                            Matias
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/wiwu-mouse">
                            WiWU
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/nzxt-mouse">
                            NZXT
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/aula-mouse">
                            AULA
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/eksa-mouse">
                            EKSA
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/deepcool-mouse">
                            DeepCool
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/gamesir-mouse">
                            GameSir
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-headphone">
                            Oraimo
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/hifuture-headphone">
                            HiFuture
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/accessories/headphone/bose-headphone">
                            Bose
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        <li>
                          <a href="https://www.startech.com.bd/jbl-speakers">
                            JBL
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/boston-speaker">
                            Boston
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/baseus-bluetooth-speaker">
                            Baseus
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-bluetooth-speaker">
                            Oraimo
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/hifuture-bluetooth-speaker">
                            HiFuture
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/tronsmart-bluetooth-speaker">
                            Tronsmart
                          </a>
                        </li>
                      </ul>
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/non-brand-bluetooth-speaker">
                            Others
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/temeisheng-bluetooth-speaker">
                            Temeisheng
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/lenovo-webcam"
                        >
                          Lenovo
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/twinmos-hubs-and-docks"
                        >
                          TwinMOS
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/corsair-capture-card"
                        >
                          Corsair
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/avermedia-capture-card"
                        >
                          AVerMedia
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/orico-capture-card"
                        >
                          ORICO
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/havit-power-strip"
                        >
                          Havit
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/maxline-power-strip"
                        >
                          Maxline
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/nano-power-strip"
                        >
                          Nano
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/targus-power-strip"
                        >
                          Targus
                        </a>
                      </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/dizo-smart-watch">
                            DIZO
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/fastrack-smart-watch">
                            Fastrack
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-smart-watch">
                            Oraimo
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/realme-smart-watch">
                            Realme
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/rIversong-smart-watch">
                            RIVERSONG
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/titan-smart-watch">
                            Titan
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/xtra-smartwatch">
                            XTRA
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/yison-smartwatch">
                            Yison
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/jbl-earphone">
                            JBL
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-earphone">
                            Oraimo
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/riversong-earphone">
                            RIVERSONG
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/trn-earphone">
                            TRN
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/xtra-earphone">
                            XTRA
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/adidas-earbuds">
                            adidas
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/boat-earbuds">
                            boAt
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/bose-earbuds">
                            Bose
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/dizo-earbuds">
                            DIZO
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/f-and-d-earbuds">
                            F&amp;D
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/g-tide-earbuds">
                            G-TiDE
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/gravastar-earbuds">
                            GravaStar{" "}
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/haylou-earbuds">
                            Haylou
                          </a>
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/jaybird-earbuds">
                            Jaybird
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/jbl-earbuds">
                            JBL
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-earbuds">
                            Oraimo
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/qcy-earbuds">
                            QCY
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/soundpeats-earbuds">
                            SoundPEATS
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/xtra-earbuds">
                            XTRA
                          </a>
                        </li>
                        <li>
                          <a href="https://www.startech.com.bd/yison-earbuds">
                            Yison
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/bose-neckband">
                            Bose{" "}
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/f-and-d-neckband">
                            F&amp;D
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-neckband">
                            Oraimo
                          </a>
                        </li>
                      </ul>
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/riversong-neckband">
                            RIVERSONG
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/xtra-neckband">
                            XTRA
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/megastar-power-bank">
                            MEGASTAR
                          </a>
                        </li>
                      </ul>
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/oraimo-power-bank">
                            Oraimo
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/philips-power-bank">
                            Philips
                          </a>
                        </li>
                        <li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/ecoflow-portable-power-station"
                        >
                          EcoFlow
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/musical-keyboard"
                    >
                      Musical Keyboard
                    </a>
                    <ul className="drop-down drop-menu-2">
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/casio-midi-controller-keyboard"
                        >
                          CASIO
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/m-audio-midi-controller-keyboard"
                        >
                          M-Audio
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/alesis-midi-controller-keyboard"
                        >
                          Alesis
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/mini-toy-drone"
                        >
                          Mini Toy Drone
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/professional-drone"
                        >
                          Professional Drone
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/enterprise-drone"
                        >
                          Enterprise Drone
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/insta360-gimbal"
                        >
                          Insta360
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/baseus-gimbal"
                        >
                          Baseus
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child multi-col">
                    ...
                    <div className="drop-down drop-menu-2">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="https://www.startech.com.bd/furgle-gaming-chair">
                            FURGLE
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/dareu-gamepad"
                        >
                          DAREU
                        </a>
                      </li>
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/gamesir-gamepad"
                        >
                          GameSir
                        </a>
                      </li>
                  ...
                  <li className="nav-item has-child">
                    ...
                    <ul className="drop-down drop-menu-2">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/singer-television"
                        >
                          SINGER
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/rowa-television"
                        >
                          ROWA
                        </a>
                      </li>
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="https://www.startech.com.bd/jvco-television"
                        >
                          JVCO
                        </a>
                      </li>
              ...
              <li className="nav-item has-child c-1">
                ...
                <ul className="drop-down drop-menu-1">
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/samsung-air-conditioner"
                    >
                      Samsung
                    </a>
                  </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/singer-air-conditioner"
                    >
                      SINGER
                    </a>
                  </li>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="https://www.startech.com.bd/haier-air-conditioner"
                    >
                      Haier
                    </a>
                  </li>
        ...
        <div className="container">
          <div className="main-footer">
            ...
            <div className="footer-block org-info">
              ...
              <p>
                <b className="store-name">Star Tech Ltd</b>
                <br />
              ...
              <p>
                <b>Email:</b>
                <br />
                <a href="mailto:webteam@startechbd.com">
